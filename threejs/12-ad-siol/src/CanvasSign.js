...
const signTexLoader = new THREE.TextureLoader().setPath('../public/assets/textures/signs/');
...
this.loadSign = function(position = new THREE.Vector3(0,0,0), rotation = new THREE.Vector3(0,0,0), scale = new THREE.Vector3(1,1,1)){
   ...
   loader.load( '../public/assets/models/signs/'+this.modelname+'.fbx', function ( object ) {
